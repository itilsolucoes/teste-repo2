...
export function Services(){
    const services = [
        ...
        {
            title:"Sistemas",
            description:"Desenvolvimento de sistemas em C# e APIs REST com Node.js",
            icon: <HiCommandLine className="h-12 w-12" />,
            },
        {
            title:"Projetos de Adequação a Lei Geral de Proteção de Dados Pessoais (LGPD)",
            description:"Consultoria, Implantação e Treinamentos",
            icon: <HiScale className="h-12 w-12" />,
            },
    ]
    return (
        <section className="container mx-auto my-12 max-w-4xl p-4">
            <div className="p-4 text-center">
                <p  className="text-sm font-semibold uppercase text-blue-600">O que faço de melhor</p>
